...
A unified timeline of every event — human logins, agent token grants, allowed actions, denied actions — with actor type, outcome, and timestamp. Filters by All / Human / Agent / Denied. Auto-refreshes every 15 seconds.
...
In your Auth0 dashboard → **Applications > APIs → Create API**
